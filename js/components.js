  ...
  return `
    <div class="aside-box">
      ...
      <div class="amazon-card">
        ${d.imagem_card ? `<div class="amazon-cover" style="background-image:url('${cldThumb(d.imagem_card, 220)}');background-size:cover;background-position:center"></div>` : `<div class="amazon-cover">📚</div>`}
